...
### Process of data cleaning and tidying the data

1. Import Library
2. Loading train, test, activity, subject, feature data
3. Assuming the records in the Y dataset and Subject is in the same order of rows in X.
